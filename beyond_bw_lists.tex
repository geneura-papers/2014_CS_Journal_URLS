...
The data used to demonstrate this consist of: % DETAILS NEEDED

\begin{itemize}
   \item A log file with the connections made by employees of an actual Spanish company.
   \item A set of rules wich decide, mostly depending on the URL core domain, if a connection should be allowed (Whitelist) or denied (Blacklist).
 \end{itemize} 

\scriptsize
\begin{verbatim}
http://www.subdomain5.....subdomain1.url_core.url_TLD/folder1/.../filename.filename_extension
\end{verbatim}
